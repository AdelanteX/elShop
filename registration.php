...
<head>
    ...
    <script type="text/javascript" src="trackbar/jquery.validate.js"></script>
...
<span class="star">*</span>
<input type="text" name="reg_patronymic" id="reg_reg_patronymic"/>
</li>

<li>
<label>E-mail</label>
<span class="star">*</span>
<input type="text" name="reg_email" id="reg_reg_email"/>
</li>

<li>
<label>Мобильный телефон</label>
<span class="star">*</span>
<input type="text" name="reg_phone" id="reg_reg_phone"/>
</li>

<li>
<label>Адресс доставки</label>
<span class="star">*</span>
<input type="text" name="reg_address" id="reg_reg_address"/>
</li>
